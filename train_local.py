...
dtype = 'bfloat16' if torch.cuda.is_available() and torch.cuda.is_bf16_supported() else 'float16'  # 'float32',
...
# define local learning
n_block = len(model.transformer.h)
split = n_block // 2  # split between the transformer and the head
